...
def blog():
    ...
    return render_template('blog_page.html', blog_list=blog_list, anime_list=anime_list, tag_list=tag_list)
...
def blog_post(slug):
    ...
    return render_template('blogs.html', post=post, anime_list=anime_list, tag_list=tag_list)
...
def first_blog():
    ...
    return render_template('first_blog.html', anime_list=anime_list, tag_list=tag_list)
